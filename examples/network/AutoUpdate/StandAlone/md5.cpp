...
void MD5::Update(const void *input,uint inputLen)
{
...
void GetMD5(MD5Code &code,void *buf,int size)
{
    MD5 md5;
...
void ToMD5(MD5Code &md5,const char *str)
{
    ParseHexStr((uint8 *)md5,(const uint8 *)str,sizeof(MD5Code));
}
