...
namespace hgl
{
    namespace db
    {
        bool ToJsonString(UTF8String &str,const FieldData *field)
        {
            if(!field)return(false);

            switch(field->GetBaseType())
            {
                case fbtBool:        str=(((FieldDataBool *)field)->value?"true":"false");return(true);
                ...
                case fbtVarChar16le:str=to_u8(((FieldDataUTF16String *)field)->string_value);return(true);
                case fbtVarChar8:    str=((FieldDataUTF8String *)field)->string_value;return(true);
        ...
        bool ParseJsonString(FieldData *field,const UTF8String &str)
        {
            if(!field)return(false);
