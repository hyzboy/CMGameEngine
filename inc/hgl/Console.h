...
#define HGL_CONSOLE_MAIN(sii_name,app_name,arg_name)	extern "C" int ConsoleAppMain(hgl::ConsoleSystemInitInfo &sii_name,hgl::ConsoleApplication &app_name,const hgl::OSStringList &arg_name)
