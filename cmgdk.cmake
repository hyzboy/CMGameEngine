...
SET(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/bin/${HGL_PLATFORM_STRING})
SET(CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/lib/${HGL_PLATFORM_STRING})
SET(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/plug-in/${HGL_PLATFORM_STRING})
...
IF(WIN32)
SET(INC_3RD_FIND_HINT ${CMAKE_CURRENT_SOURCE_DIR}/3rdpty/inc)
SET(LIB_3RD_FIND_HINT ${CMAKE_CURRENT_SOURCE_DIR}/3rdpty/lib${HGL_BITS})
ENDIF(WIN32)

link_directories(${CMAKE_ARCHIVE_OUTPUT_DIRECTORY})

INCLUDE_DIRECTORIES(${CMAKE_CURRENT_SOURCE_DIR}/inc)
INCLUDE_DIRECTORIES(${CMAKE_CURRENT_SOURCE_DIR}/inc/cml)
INCLUDE_DIRECTORIES(${CMAKE_CURRENT_SOURCE_DIR}/3rdpty/MathGeoLib/src)

link_directories(${CMAKE_CURRENT_SOURCE_DIR}/3rdpty/MathGeoLib)
...
# 	ENDIF(BUILD_OPENAL_LIB)
	...
	IF(BUILD_OPENGL_LIB)
		INCLUDE_DIRECTORIES(${CMAKE_CURRENT_SOURCE_DIR}/3rdpty/glew/include)
		SET(GLEW_SOURCE ${CMAKE_CURRENT_SOURCE_DIR}/3rdpty/glew/src/glew.c)

		INCLUDE_DIRECTORIES(${CMAKE_CURRENT_SOURCE_DIR}/3rdpty/glfw/include/GLFW)
		LINK_DIRECTORIES(${CMAKE_CURRENT_SOURCE_DIR}/3rdpty/glfw/src)
	ENDIF(BUILD_OPENGL_LIB)
ENDIF(UNIX)
...
IF(WIN32)
    ...
    FIND_PATH(EXPAT_INCLUDE_DIR
        ...
        HINTS
        ${INC_3RD_FIND_HINT}
		${CMAKE_CURRENT_SOURCE_DIR}/3rdpty/expat/lib)
    INCLUDE_DIRECTORIES(${EXPAT_INCLUDE_DIR})
    ...
    FIND_PATH(EXPAT_LIBRARY_DIR
        ...
        HINTS
        ${LIB_3RD_FIND_HINT}
		${CMAKE_CURRENT_SOURCE_DIR}/3rdpty/expat/${CMAKE_BUILD_TYPE}
		)
    LINK_DIRECTORIES(${EXPAT_LIBRARY_DIR})
	...
	FIND_PATH(APR_INCLUDE_DIR
		...
		HINTS
		${INC_3RD_FIND_HINT}
		${CMAKE_CURRENT_SOURCE_DIR}/3rdpty/apr)
	INCLUDE_DIRECTORIES(${APR_INCLUDE_DIR})
	...
	FIND_PATH(APR_LIBRARY_DIR
        ...
        HINTS
        ${LIB_3RD_FIND_HINT}
		${CMAKE_CURRENT_SOURCE_DIR}/3rdpty/apr/${CMAKE_BUILD_TYPE}
		)
	LINK_DIRECTORIES(${APR_LIBRARY_DIR})
...
SET(HGL_QT_MAIN_SOURCE ${CMAKE_CURRENT_SOURCE_DIR}/src/OS/QT/PlatformQT4.cpp)
SET(HGL_QT_LIB QT4Support)

IF(UNIX)
	MESSAGE("Host OS is UNIX")

	SET(HGL_CONSOLE_MAIN_SOURCE ${CMAKE_CURRENT_SOURCE_DIR}/src/OS/UNIX/UnixConsole.cpp)
	SET(HGL_GRAPHICS_MAIN_SOURCE ${CMAKE_CURRENT_SOURCE_DIR}/src/OS/UNIX/UnixOpenGL.cpp)
...
IF(WIN32)
	...
	SET(HGL_CONSOLE_MAIN_SOURCE ${CMAKE_CURRENT_SOURCE_DIR}/src/OS/Win/WinConsole.cpp)
	SET(HGL_BASE_LIB ${HGL_BASE_LIB} AngelScript)
	SET(HGL_GUI_MAIN_SOURCE ${CMAKE_CURRENT_SOURCE_DIR}/src/OS/Win/WinGame.cpp)
	SET(HGL_CONSOLE_LIB ${HGL_BASE_LIB} ${HGL_NETWORK_LIB})
ENDIF(WIN32)
