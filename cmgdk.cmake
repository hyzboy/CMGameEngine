...
IF(BUILD_QT4_SUPPORT_LIB)
	...
	IF(WIN32)
		SET(HGL_QT_MAIN_SOURCE ${CMGDK_PATH}/src/OS/QT/PlatformQT4WinUTF16.cpp)
	ELSE()
		SET(HGL_QT_MAIN_SOURCE ${CMGDK_PATH}/src/OS/QT/PlatformQT4UnixUTF8.cpp)
	ENDIF()
...
IF(BUILD_QT5_SUPPORT_LIB)
	...
	IF(WIN32)
		SET(HGL_QT_MAIN_SOURCE ${CMGDK_PATH}/src/OS/QT/PlatformQT5WinUTF16.cpp)
	ELSE()
		SET(HGL_QT_MAIN_SOURCE ${CMGDK_PATH}/src/OS/QT/PlatformQT5UnixUTF8.cpp)
	ENDIF()
...
IF(UNIX)
	...
	SET(HGL_CONSOLE_MAIN_SOURCE ${CMGDK_PATH}/src/OS/UNIX/UnixConsole.cpp)
	SET(HGL_GRAPHICS_MAIN_SOURCE ${CMGDK_PATH}/src/OS/UNIX/UnixOpenGL.cpp)
