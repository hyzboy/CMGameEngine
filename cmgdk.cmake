...
OPTION(BUILD_JSON_SUPPORT       "Include Json support"                      ON)
...
IF(WIN32)
    ...
    IF(BUILD_JSON_SUPPORT)
        add_subdirectory(${CMGDK_PATH}/3rdpty/jsoncpp)
...
IF(BUILD_JSON_SUPPORT)
    SET(HGL_CONSOLE_LIB ${HGL_CONSOLE_LIB} jsoncpp)
    SET(HGL_GRAPHICS_LIB ${HGL_GRAPHICS_LIB} jsoncpp)
ENDIF(BUILD_JSON_SUPPORT)
