...
ELSE(WIN32)
    ...
    SET_PROPERTY(CACHE X86_USE_CPU_COMMAND PROPERTY STRINGS SSE2 SSE3 SSE4 SSE41 SSE42 AVX)
ENDIF(WIN32)
...
IF(UNIX)
    ...
    ELSEif(X86_USE_CPU_COMMAND STREQUAL SSE3)
        add_definitions("-DMATH_SSE3")
        add_definitions(-msse3)
    elseif(X86_USE_CPU_COMMAND STREQUAL 2)
        add_definitions("-DMATH_SSE2")
        add_definitions(-msse2)
    elseif(X86_USE_CPU_COMMAND STREQUAL SSE)
...
IF(WIN32)
    ...
    elseif(X86_USE_CPU_COMMAND STREQUAL SSE2)
        add_definitions("-DMATH_SSE2")
