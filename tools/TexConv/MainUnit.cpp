...
//贴图数据源格式
OpenGLCoreTextureFormat tf_list[]=
{
...
const	int							tf_count	=sizeof(tf_list)/sizeof(OpenGLCoreTextureFormat);
		OpenGLCoreTextureFormat *	glfmt[4]	={NULL,NULL,NULL,NULL};				//选中格式
...
//--------------------------------------------------------------------------------------------------
OpenGLCoreTextureFormat *GetFormat(const char *str)
{
	OpenGLCoreTextureFormat *p=tf_list;
...
//--------------------------------------------------------------------------------------------------
OpenGLCoreTextureFormat *CheckOpenGLCoreFormat(const CmdParse &cmd,const os_char *flag)
{
	OSString fmtstr;
...
{
	uint pixels=0;
	OpenGLCoreTextureFormat *curfmt=NULL;
	OpenGLCoreTextureFormat *tarfmt=NULL;
