...
void news_jx_fz(const UTF8String &user_agent,const OSString &save_path)
{
    MakePath(save_path);
...
HGL_CONSOLE_MAIN_FUNC()
{
    ...
    std::cout<<std::endl<<"江西抚州"<<std::endl;
    news_jx_fz(user_agent,MergeFilename(save_doc_path,"江西抚州"));
