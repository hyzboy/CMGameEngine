...
IF(BUILD_OPENGL_LIB)
    ...
    SET(OPENGL_USE_PROFILE CORE CACHE STRING "OpenGL Profile select")

    SET_PROPERTY(CACHE OPENGL_USE_PROFILE PROPERTY STRINGS CORE ES1 ES2 ES3 ES31 ES32)

	IF(OPENGL_USE_PROFILE STREQUAL CORE)
# 		ADD_DEFINITIONS("-DGLFW_INCLUDE_GLCOREARB")
		...
		ENDIF()
	ELSEIF(OPENGL_USE_PROFILE STREQUAL ES1)
